...
def centererd(): # 'centering ist ein python eigenname, das Python Modul wird hiermit überschrieben. Das kann zu Problemen führen.'
...
def pca(centered_img, prop_var): #added input variable centered_img
